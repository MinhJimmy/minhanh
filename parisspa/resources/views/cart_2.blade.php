                    ...
                    <div class="row">
                        <div class="col-lg-4 offset-lg-8">
                            <div class="proceed-checkout">
                                ...
                                <center>  <h4> Phương Thức Thanh Toán</h4> </center>
                                <br>
                               <a href="{{ route('checkout') }}" class="proceed-btn">Thanh Toán Trực Tiếp </a>
                    <br>
                                <form action="{{ route('vnpay_payment') }}" method="POST">
                                    @csrf
                                    <center>   <button type="submit" name="redirect" class="proceed-btn_2"> THANH TOÁN VNPAY </center>
