...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <header class="app-header">
    ...
    <ul class="app-nav">
      ...
      <!-- User Menu-->
      <li><a class="app-nav__item" href="{{URL::to('/')}}"><i class='bx bx-log-out bx-rotate-180'></i> </a>
        ...
        <div class="tile">
          ...
          <div class="row">
            ...
            <div class="tile-footer col-md-12">
              ...
              <a class="btn btn-secondary luu-va-in" href="{{URL::to('/admin')}}">Quay về</a>
            </div>
          </div>
        </div>
        </div>
...
-->
  ...
  <!-- Data table plugin-->
  <script type="text/javascript" src="{('public/frontend/doc/js/plugins/jquery.dataTables.min.js')}}"></script>
  <script type="text/javascript" src="{('public/frontend/doc/js/plugins/dataTables.bootstrap.min.js')}}"></script>
