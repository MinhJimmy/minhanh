			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Kem Đặc Trị Mụn 2022</h2>
						<div class="col-sm-4">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="{{('public/frontend/shop/images/home/SP_12.jpg')}}" alt="" />
										<h2>$69</h2>
										<p>Kem Loreal</p>
										{{-- <a href="{{URL::to('/oder_1')}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> --}}
										<button class="btn btn-default add-to-cart addToCart" data-prod="6"><i class="fa fa-shopping-cart"></i>Mua Hàng</button>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="{{('public/frontend/shop/images/home/SP_9.jpg')}}" alt="" />
										<h2>$64</h2>
										<p>Kem Orlane Vitamin</p>
										{{-- <a href="{{URL::to('/oder_1')}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> --}}
										<button class="btn btn-default add-to-cart addToCart" data-prod="3"><i class="fa fa-shopping-cart"></i>Mua Hàng</button>
									</div>
								</div>
								<img src="{{('public/frontend/shop/images/home/new.png')}}" class="new" alt="" />
							</div>
