			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Kem Dưỡng Trắng Da 2022</h2>
						<div class="col-sm-4">
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="{{('public/frontend/shop/images/home/SP_23.jpg')}}" alt="" />
										<h2>$84</h2>
										<p>Kem Orlan Paris Body</p>
										{{-- <a href="{{URL::to('/oder_1')}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> --}}
										<button class="btn btn-default add-to-cart addToCart" data-prod="22"><i class="fa fa-shopping-cart"></i>Mua Hàng</button>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="{{('public/frontend/shop/images/home/SP_28.jpg')}}" alt="" />
										<h2>$88</h2>
										<p>Kem Mon Paris</p>
										{{-- <a href="{{URL::to('/oder_1')}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> --}}
										<button class="btn btn-default add-to-cart addToCart" data-prod="27"><i class="fa fa-shopping-cart"></i>Mua Hàng</button>
